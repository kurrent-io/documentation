...
- Creates `my-operator-namespace` and deploys the Operator into it.
- Deploys CRDs.
...
oc create namespace my-operator-namespace
...
```bash
kubectl get -n my-operator-namespace deployments
```
...
```bash
kubectl events -n my-operator-namespace
```
...
```bash
kubectl logs -n my-operator-namespace deployments/kurrentdb-operator
```
