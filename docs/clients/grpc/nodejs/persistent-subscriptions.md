...
head:
  - - title
    - {}
    - Persistent Subscriptions | Node.js | Clients | Kurrent Docs
---
...
@[code{create-persistent-subscription-to-stream}](@grpc:persistent-subscriptions.js;persistent-subscriptions.ts)
...
@[code{create-persistent-subscription-to-all}](@grpc:persistent-subscriptions.js;persistent-subscriptions.ts)
...
@[code{subscribe-to-persistent-subscription-to-stream}](@grpc:persistent-subscriptions.js;persistent-subscriptions.ts)
...
@[code{subscribe-to-persistent-subscription-to-all}](@grpc:persistent-subscriptions.js;persistent-subscriptions.ts)
...
@[code{subscribe-to-persistent-subscription-with-manual-acks}](@grpc:persistent-subscriptions.js;persistent-subscriptions.ts)
...
@[code{update-persistent-subscription}](@grpc:persistent-subscriptions.js;persistent-subscriptions.ts)
...
@[code{delete-persistent-subscription}](@grpc:persistent-subscriptions.js;persistent-subscriptions.ts)
